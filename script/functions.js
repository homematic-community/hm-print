			  ...
			  var e = node.childNodes[y];
				if (e.onclick != null)
				{
					...
					if ( fname.indexOf("EditScript") > -1)
					{
						...
						var req = xhr.create();
		  			req.open("POST", "/addons/script/exec.cgi", false);
